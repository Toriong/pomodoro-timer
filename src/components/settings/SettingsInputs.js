...
const SettingsInputs = ({ setIsSettingsOn }) => {
    ...
    const handleFocusTimeOnChange = event => { setFocusTimeMinsNew(event.target.value) }

    const handleBreakTimeOnChange = event => { setBreakTimeMinsNew(event.target.value) }
    ...
    return (
        <>
            <div>
                <div>
                    ...
                    <input
                        ...
                        onChange={event => { handleFocusTimeOnChange(event) }} />
                </div>
                <div>
                    ...
                    <input
                        ...
                        onChange={event => { handleBreakTimeOnChange(event) }}
                    />
                </div>
                <div id='alarmInputContainer'>
                    ...
                    <button
                        value={isAlarmOn}
                        onClick={event => { handleIsAlarmOnBtnClick(event) }}
                    >
            ...
            <div>
                <button onClick={event => { handleSaveBtnClick(event) }}>Save</button>
            </div>
        </>
    )
}
